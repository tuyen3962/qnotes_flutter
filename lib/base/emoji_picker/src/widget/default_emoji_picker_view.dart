...
class DefaultEmojiPickerView extends EmojiPickerBuilder {
  const DefaultEmojiPickerView(Config config, EmojiViewState state, {super.key}) : super(config, state);
            ...
            children: [
              ...
              Flexible(
                child: PageView.builder(
                  ...
                  itemBuilder: (context, index) => _buildPage(emojiSize, widget.state.categoryEmoji[index]),
                ),
              ),
            ],
          ),
